#
# Extra Credit R Project Solutions
# Maddie Zug
# Harvey Mudd College
# May 2017
#
...
percent_big_in_lifetime <- sum(big_in_lifetime == "Yes")/length(big_in_lifetime)
...
percent_worried_general_pacific <- sum((how_worried_general>="Somewhat worried")&(region == "Pacific"))/sum(region=="Pacific")

# What % of respondents in the Pacific Region are at least somewhat worried about "The Big One"?
percent_worried_big_pacific <- sum((how_worried_big>="Somewhat worried")&(region == "Pacific"))/sum(region=="Pacific")

# What % of respondents in the Pacific Region think "The Big One" will occur in their lifetime?
percent_big_in_lifetime_pacific <- sum((big_in_lifetime == "Yes")&(region == "Pacific"))/sum(region == "Pacific")
